...
namespace DiiaUITests.Features
{
    ...
    [NUnit.Framework.CategoryAttribute("mailPage")]
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Check search results with valid input")]
        [NUnit.Framework.CategoryAttribute("valid")]
        public virtual void CheckSearchResultsWithValidInput()
        {
...
#line hidden
#line 15
 testRunner.Then("Open search result page with text \'За вашим запитом знайдено матеріалів: \'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Check the search input with no results")]
        [NUnit.Framework.CategoryAttribute("invalid")]
        public virtual void CheckTheSearchInputWithNoResults()
        {
            string[] tagsOfScenario = new string[] {
                    "invalid"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Check the search input with no results", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 18
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
