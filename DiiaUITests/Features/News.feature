...
Scenario: Check navigation to first news
	...
	Then I navigate to the News page with title "Відповіді на запитання щодо COVID-сертифікатів у Дії: Мінцифра запустила лендинг"
...
Scenario: Check navigation to third news
	...
	Then I navigate to the News page with title "COVID-сертифікат у Дії стане отримати простіше: що змінилося"
